...
Imagine we want to create a database for a simple CRUD app, such as a video game tracker. The naive way to do that would be to create a single table called `games` like this:
